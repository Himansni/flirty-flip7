...
(function configureOnlineGames(global) {
  ...
  function safeMessage(error, fallback = "Unable to complete that request.") {
    ...
    if (code.includes("invalid_login_credentials") || code.includes("invalid login credentials")) return "The email or password was not accepted. Please check your credentials and try again.";
